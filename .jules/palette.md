...
## 2024-11-25 - Progressive Constraint and Shortcut Reveal
**Learning:** For strict form inputs with hidden keyboard shortcuts, users can miss functionality if it is not explicitly communicated.
