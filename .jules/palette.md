...
## 2024-04-02 - Progressive Disclosure of Hidden Shortcuts
**Learning:** For strict form inputs with hidden keyboard shortcuts (like pressing Enter to submit a single-word check-in), users and screen readers may be unaware of the shortcut if not explicitly shown.
